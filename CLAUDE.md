...
not a wrong primitive. Stage 8 adds one known-answer vector with msoffcrypto-tool as the
oracle, stored as input and output bytes. It is not Office support and must not become it — no
constants, no block keys.
