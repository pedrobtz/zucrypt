...
Roadmap Stages 0–6 are complete; the package is at version 0.1.0 with the C ABI frozen at
`ZUCRYPT_ABI_VERSION 1`. The package builds a vendored TF-PSA-Crypto 1.1.1 crypto
...
remaining release gates, is the current stage.
...
**The ABI is frozen.** Within major version 1, functions and table fields may be *added*;
nothing is removed, reordered or given a new meaning; enumerator values are permanent; and a
...
it — no constants, no block keys, no salts.
