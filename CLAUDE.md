...
(Stages 7–12), adopted 2026-09-25. Stages 0–5, 7 and 8 are complete
(Stage 5 closed with Stage 8, once its weekly gates ran real tests).
**Stage 9 — documentation that matches the code, and the tag — is the
current stage** ([\#41](https://github.com/pedrobtz/zucrypt/issues/41)).
Stage 6 was prepared and never tagged; its remaining items are Stages
7–9, and nothing is tagged yet
