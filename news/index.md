...
Both shapes the `zu*` family consumes siblings by, with the ABI frozen
at `ZUCRYPT_ABI_VERSION 1`:
...
reproduce this package’s build configuration. Within major version 1,
functions and table fields may be added and nothing is removed,
reordered, or given a new meaning; see
